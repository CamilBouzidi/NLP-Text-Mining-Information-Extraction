# Thank you to the COMP474 Winter2022 team for this tutorial!
import spacy
import spacy.language

# Create a custom component to count number of title-cased tokens
@spacy.language.Language.component("custom_title_counter")
...
# Add to our pipeline
nlp.add_pipe("custom_title_counter")
print(nlp.pipe_names)
